...
class VCritic(nn.Module):
    ...
    def parse_model_args(parser):
        ...
        - critic_dropout_rate
        '''
        parser.add_argument('--critic1_hidden_dims', type=int, nargs='+', default=[128], 
                            help='specificy a list of k for top-k performance')
        parser.add_argument('--critic1_dropout_rate', type=float, default=0.2, 
...
#         self.state_encoder = policy.state_encoder
        self.net = DNN(self.state_dim, args.critic1_hidden_dims, 1, 
                       dropout_rate = args.critic1_dropout_rate, do_batch_norm = True)
