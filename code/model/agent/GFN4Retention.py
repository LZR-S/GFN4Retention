...
class GFN4Retention(BaseRLAgent):
    ...
    def parse_model_args(parser):
        ...
        parser.add_argument('--gfn_reward_smooth', type=float, default=1.0, 
                            help='reward smooth offset in the backward part of TB loss') #b_r 1.0
        
        parser.add_argument('--gfn_Z', type=float, default=0., 
                            help='average reward offset') #b_z 0
    ...
    def get_gfn_loss(self, observation, policy_output, user_feedback, done_mask, next_observation):
        ...
        #DB_backward_nonterminal = log_F_next + log_P_B + user_feedback['immediate_response'].view(-1,1)
