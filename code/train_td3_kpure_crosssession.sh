...
do
    ...
    do
        ...
        do
            for ACTOR_LR in 0.0003 # 0.0003 # 0.00001
            do
                ...
                do
                    ...
                    file_key=SAC_${POLICY_CLASS}_${ENV_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_fret${FEEDBACK_INF_RETURN}_seed${SEED}
