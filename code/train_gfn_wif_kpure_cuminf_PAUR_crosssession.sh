...
do
    ...
    do
        ...
        do
            ...
            do
                for ZZZ in 0.5 0.7 0.9 1.1 1.3 1.5 # 0.5 0.7 0.9 1.1 1.3 1.5
                do
                    for SEED in 11 # 11 13 17 19 23
                    do
                    file_key=gfn4retention_wif_mean_PAUR_balanceterm${ZZZ}_${POLICY_CLASS}_${ENV_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_fret${FEEDBACK_INF_RETURN}_seed${SEED}
