...
# agent arguments
AGENT_CLASS='GFN4Retention_wif_ablation'
GAMMA=0.9
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    file_key=gfn4retention_wif_ablation_PAUR_${POLICY_CLASS}_${ENV_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_fret${FEEDBACK_INF_RETURN}_seed${SEED}
